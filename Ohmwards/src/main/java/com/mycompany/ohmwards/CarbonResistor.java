...
public class CarbonResistor extends Resistor {
    ...
    public CarbonResistor(String colourCode, ConnectionType type, Vector<Double> position, double voltage, double current, double resistance, double power, String name, Direction direction) {
